...
const ContactUsForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    emailjs
      .send(
        'service_fmvmvlc', // paste your ServiceID here (you'll get one when your service is created).
        'template_rbmp9uw', // paste your TemplateID here (you'll find it under email templates).
        {
          from_name: form.email,
          to_name: 'Hatem', // put your name here.
